# -*- coding: utf-8 -*-
"""
Live tests against an in-memory SQLite database.
...
class TestLiveSQLite(unittest.TestCase):
    ...
    def test_filter_icontains(self):
        ...
        self.assertEqual(len(rows), 2)  # John Smith, Bob Smith
    ...
    def test_order_and_limit(self):
        ...
        self.assertEqual(rows[1]["age"], 35)
    ...
    def test_insert(self):
        ...
        self.cur.execute("SELECT COUNT(*) FROM users WHERE first_name = ?", ("Charlie",))
    ...
    def test_update(self):
        ...
        self.cur.execute("SELECT status, age FROM users WHERE id = 1")
    ...
    def test_wildcard_literal_percent(self):
        ...
        # Insert a row that contains a literal percent sign
        query, values = filtersql({
            "action": "insert",
            "source": "users",
            "values": {
        ...
        self.assertEqual(rows[0]["last_name"], "50% off")
